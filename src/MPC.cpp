...
// reference speed
const double ref_v = 65 * 0.44704; // 70 MPH convert mile/hour to m/sec
...
vector<double> MPC::Solve(Eigen::VectorXd state, Eigen::VectorXd coeffs) {
  ...
  result.push_back( solution.x[delta_start]); // actuator values
